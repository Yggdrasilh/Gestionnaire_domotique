...
abstract class Controller
{
    ...
    protected $baseUrlApi = "https://www.cefii-developpements.fr/noah1375/Api_GD/public/";  // Base d'url pour l'API
    protected $baseUrlSite = "https://www.cefii-developpements.fr/noah1375/Gestionnaire_domotique/public/"; //base d'url pour le Site
